	...
	<section class="section-padding">
		<div class="container">
			<div class="row showcase-section">
				<div class="col-md-6">
					<img src="plugins/home-plugins/img/img1.png" alt="showcase image">
				</div>
				<div class="col-md-6">
					...
					<div class="about">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<p>The global economy is disturbed as the new statistics shows. The post-COVID-19 pandemic downturn seems serious as unemployment shall be dominating in and after the calendar year 2021.
...
The recent studies have estimated 18 million resumes doing rounds on various online job portals</p>
							</div>
							<div class="col-md-4">
								<div class="block-heading-two">
								...
								<!-- Accordion starts -->
								<p>The majority of Recruitment Software and Job Portal business are commonly designed with the significant topographies of higher engagement for both employers and job seekers and can avail the benefits of these features to enhance their user experiences to select the right candidate on right place. The acceptance benchmarks of a job portals are on its competence to solve a common set of below Job Board business challenges.<b>Centralised access</b> for all stakeholders.<b>Seamless workflow</b> assimilation with recruitment process.</p>
								<!-- Accordion ends -->
