...
<head>
<meta charset="utf-8">
<title>EASYJOB / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>MOBILE No. +91 9655035643</p>
                <?php if (isset($_SESSION['APPLICANTID'])) { 
                    ...
                    echo ' <p class="pull-right login"><a title="View Notification(s)" href="'.web_root.'applicant/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-success">'.$notif.'</span></a> | <a title="View Message(s)" href="'.web_root.'applicant/index.php?view=message"> <i class="fa fa-envelope-o"></i> <span class="label label-success">'.$msg.'</span></a> | <a title="View Profile" href="'.web_root.'applicant/"> <i class="fa fa-user"></i> Howdy, '. $appl->FNAME. ' '.$appl->LNAME .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';
                      ...
                      <p   class="pull-right login"><a data-target="#mycompanyModal" data-toggle="modal" href=""> <i class="fa fa-lock"></i> Company Login </a></p>
                <?php } ?>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">EASYJOB<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Melaveethi,Thanjavur<br>
           Pin-613121 Tamilnadu,India.</address>
          <p>
            <i class="icon-phone"></i> +91 9655035643<br>
            <i class="icon-envelope-alt"></i> roshanbhalaji007@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Copyright 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
