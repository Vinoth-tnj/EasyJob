  ...
  <!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/6.jpg" alt="" />
                  ...
                  <!-- Panel heading -->
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> Meta Layoffs Mostly Affected Tech Team, Reorganisation Underway, Say Execs
                      </a>
                    </h4>
                   </div>
                  ...
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>Nowadays Easy to apply for a job through online job Portals
                      </a>
                    </h4>
                   </div>
                  ...
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> Job Openings In 'Development Of E-Commerce Portal of Ministry Of Textiles' Project
                      </a>
                    </h4>
                   </div>
